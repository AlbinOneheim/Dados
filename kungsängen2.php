...
<body>
    ...
    <main class="sabatsberg">
        ...
        <div class="pilar">
        <a href="./kungsängen.php" class="pil-vänster-2"><i class='fas fa-arrow-left'></i></a>
        <?php
            
            echo "<h4 class=\"veckonummer\">Vecka " . date("W", strtotime("+1 week")) . "</h4>";
        ?>
        <a href="./kungsängen3.php" class="pil-höger-2"><i class='fas fa-arrow-right'></i></a>
    </div>
        <div class="matmeny">
            <div class="måndag">
