...
<body>
    ...
    <main class="sabatsberg">
        ...
        <div class="pilar">
        <a href="./kungsängen3.php" class="pil-vänster-4"><i class='fas fa-arrow-left'></i></a>
        <?php
            
            echo "<h4 class=\"veckonummer\">Vecka " . date("W", strtotime("+3 week")) . "</h4>";
        ?>
        <a href="./kungsängen5.php" class="pil-höger-4"><i class='fas fa-arrow-right'></i></a>
    </div>
        <div class="matmeny">
            <div class="måndag">
