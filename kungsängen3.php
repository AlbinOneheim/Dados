...
<body>
    ...
    <main class="sabatsberg">
        ...
        <div class="pilar">
        <a href="./kungsängen2.php" class="pil-vänster-3"><i class='fas fa-arrow-left'></i></a>
        <?php
            
            echo "<h4 class=\"veckonummer\">Vecka " . date("W", strtotime("+2 week")) . "</h4>";
        ?>
        <a href="./kungsängen4.php" class="pil-höger-3"><i class='fas fa-arrow-right'></i></a>
    </div>
        <div class="matmeny">
            <div class="måndag">
